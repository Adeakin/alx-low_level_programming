...
- Note: The prototypes of all functions and the prototype of the function _putchar must be included in the header file called main.h
~ Start by creating your `main.h` first.
```
